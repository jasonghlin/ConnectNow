...
# 安裝必要的包
sudo apt-get update
sudo apt install -y git || { echo "套件安裝失敗" >> /var/log/user-data.log; exit 1; }
...
# 啟動 docker-compose
cd /home/ubuntu/ConnectNow/practice/videoSrt
sudo docker compose -f /home/ubuntu/ConnectNow/practice/videoSrt/docker-compose.yml up --build -d
